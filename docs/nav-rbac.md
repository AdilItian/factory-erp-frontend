...
**Key Insight**: Navigation visibility is UX only, not security. Filtering is done entirely client-side.
...
Plans and features require server-side verification. Options:
