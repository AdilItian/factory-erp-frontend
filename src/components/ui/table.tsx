...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn(
        'bg-muted/40 [&_tr]:border-border/60 [&_tr]:hover:bg-transparent [&_tr]:border-b',
        className
      )}
      {...props}
    />
...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'bg-muted/40 border-border/60 border-t font-medium [&>tr]:last:border-b-0',
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot='table-row'
      className={cn(
        'border-border/50 hover:bg-muted/40 data-[state=selected]:bg-muted/50 border-b transition-colors',
        className
      )}
      {...props}
    />
